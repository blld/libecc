...
Interface(Object,
	...
	(struct Value, getMember ,(struct Context *, struct Object *, struct Key key))
	(struct Value, putMember ,(struct Context *, struct Object *, struct Key key, struct Value))
	...
	(struct Value, getElement ,(struct Context *, struct Object *, uint32_t index))
	(struct Value, putElement ,(struct Context *, struct Object *, uint32_t index, struct Value))
	...
	(struct Value, getProperty ,(struct Context *, struct Object *, struct Value primitive))
	(struct Value, putProperty ,(struct Context *, struct Object *, struct Value primitive, struct Value))
	...
	(struct Value, putValue ,(struct Context *, struct Object *, struct Value *, struct Value))
	(struct Value, getValue ,(struct Context *, struct Object *, struct Value *))
