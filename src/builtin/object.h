...
Interface(Object,
	...
	(struct Value *, member ,(struct Object *, struct Key, enum Value(Flags)))
	...
	(struct Value *, element ,(struct Object *, uint32_t, enum Value(Flags)))
	...
	(struct Value *, property ,(struct Object *, struct Context * const, struct Value, enum Value(Flags)))
